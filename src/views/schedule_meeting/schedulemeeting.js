      ...
      <CCol>
        <CCard>
          ...
          <DatePicker
              ...
              dateFormat="Pp"
            />
           <CSelect size="sm" width="40px" className="mb-3" aria-label="Small select example">
            ...
            <CCard>
                <CCardHeader component="h5">Notification</CCardHeader>
                <CCardBody>
